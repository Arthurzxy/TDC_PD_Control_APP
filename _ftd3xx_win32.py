...
_libname = 'FTD3XXWU.dll'
_libraries = {}
_libpath = Path(__file__).resolve().with_name(_libname)
# 优先加载工程 app 目录中的 DLL，避免误命中系统目录中的旧版 ftd3xx.dll。
_libraries[_libname] = WinDLL(str(_libpath if _libpath.exists() else _libname), winmode=0)
